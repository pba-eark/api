...
namespace pba_api.Migrations
{
    ...
    [Migration("20221217142755_AddSheetStatusColor")]
    partial class AddSheetStatusColor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pba_api.Models.EstimateSheetRoleModel.EstimateSheetRole", b =>
                {
                    b.Property<int>("EstimateSheetId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("EstimateSheetId", "RoleId");

                    b.HasIndex("RoleId");

                    b.ToTable("EstimateSheetRoles");
            ...
            modelBuilder.Entity("pba_api.Models.SheetStatusModel.SheetStatus", b =>
                {
                    ...
                    b.Property<string>("SheetStatusColor")
                        .HasMaxLength(50)
                        .HasColumnType("varchar(50)");
            ...
            modelBuilder.Entity("pba_api.Models.EstimateSheetModel.EstimateSheet", b =>
                {
                    ...
                    b.Navigation("EstimateSheetRoles");
